...
def upgrade():
    ...
    sa.Column('Augmentation_discrète_du_collagène_endo.', sa.Boolean(), nullable=True),
    ...
    sa.Column('Réseau_intermyofribrillaire_irrégulier', sa.Boolean(), nullable=True),
    ...
    sa.Column('Accumulation_mitochondrie_périphérique', sa.Boolean(), nullable=True),
    ...
    sa.Column('Fibre_atrophique:_Halo_foncé_sous_sarcolemmale', sa.Boolean(), nullable=True),
    ...
    sa.Column('Phospho_Faiblement_positif_de_façon_diffuse', sa.Boolean(), nullable=True),
    ...
    sa.Column('Surcharge_dans_les_fibre_remaniées_/_anormales', sa.Boolean(), nullable=True),
    sa.Column('Fibre_type_II_plus_riche_que_les_fibre_type_I', sa.Boolean(), nullable=True),
